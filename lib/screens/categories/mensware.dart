...
class Mensware extends StatefulWidget {
  final VoidCallback? onSearchPressed; // Keep for compatibility, optional

  const Mensware({super.key, this.onSearchPressed});

  @override
  _MenswareState createState() => _MenswareState();
}

class _MenswareState extends State<Mensware> {
  final TextEditingController _searchController = TextEditingController();
  String searchQuery = '';

  // Sample menswear products
  static const List<Map<String, dynamic>> menswearProducts = [
    {
      'name': 'Slim Fit Shirt',
      'price': 1999,
      'oldPrice': 2499,
  ...
  Widget build(BuildContext context) {
    ...
    final filteredProducts =
        menswearProducts.where((product) {
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search Menswear Products...',
