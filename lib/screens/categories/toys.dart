...
import 'package:nexkart6/providers/wishlist_provider.dart' as wishlist_provider;
...
class _ToysScreenState extends State<ToysScreen> {
  ...
  // Sample toy products with fields matching Mensware and WoMenWearScreen
  static const List<Map<String, dynamic>> toyProducts = [
    {
      'name': 'Remote Car',
      'price': 799,
      'oldPrice': 999,
                ...
                filteredProducts.isEmpty
                    ...
                    : GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 2,
                        mainAxisExtent:
                            400.h, // Increased to match Mensware/WoMenWearScreen
