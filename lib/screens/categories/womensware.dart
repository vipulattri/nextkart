...
class WoMenWearScreen extends StatefulWidget {
  ...
  @override
  _WoMenWearScreenState createState() => _WoMenWearScreenState();
}
...
class _WoMenWearScreenState extends State<WoMenWearScreen> {
  ...
  // Women's wear products with fields matching Mensware
  static const List<Map<String, dynamic>> womenswearProducts = [
    {
      'name': 'Palazzo',
      'price': 1299,
      'oldPrice': 2499,
      'discount': 20,
      'brand': 'Schnell',
      'image': 'assets/images/palazzo.webp',
      'rating': 4.3,
      'reviews': 850,
      'stock': true,
    },
    {
      ...
      'discount': 30,
      'brand': 'Zara',
      'image': 'assets/images/lahanga.jpg',
      'rating': 4,
      'reviews': 1200,
      'stock': true,
    },
    ...
    },
    {
      ...
      'discount': 30,
      'brand': 'Balenciaga',
      'image': 'assets/images/salwar.webp',
      'rating': 4.6,
      'reviews': 1200,
      'stock': true,
    },
  ...
  Widget build(BuildContext context) {
    ...
    final filteredProducts =
        womenswearProducts.where((product) {
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search Women\'s Wear Products...',
